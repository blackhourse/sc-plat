...
public class RoleController {
    ...
    public CommonResult<Integer> createRole(@Valid RoleCreateDTO createDTO) {
        return success(roleService.createRole(createDTO, 1));
    }
    ...
    public CommonResult<List<Integer>> getRoleByUserId(@RequestParam("userId") Integer userId) {
        return success(roleService.getUserRoleInfo(userId));
    }
