...
import cn.boot.st.securityserver.filter.CustomClientCredentialsTokenEndpointFilter;
import cn.boot.st.securityserver.service.JdbcClientDetailsServiceImpl;
import cn.boot.st.securityserver.service.UserDetailsServiceImpl;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            CommonResult<Object> result = CommonResult.error(SecurityServerConstants.CLIENT_AUTHENTICATION_FAILED.getCode(),
                    SecurityServerConstants.CLIENT_AUTHENTICATION_FAILED.getMessage());
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(
                new ClassPathResource("sc-plat.jks"), "123456".toCharArray());
        KeyPair keyPair = factory.getKeyPair(
                "sc-plat", "123456".toCharArray());
        return keyPair;
    }
