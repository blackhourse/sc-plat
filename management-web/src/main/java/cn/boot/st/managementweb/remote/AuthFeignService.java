...
import cn.boot.st.managementweb.remote.fallback.AuthWebServiceFallbackFactory;
 ...
 * @create: 2020-12-11
 **/
@FeignClient(name = ServiceNameConstants.SECURITY_SERVER_SERVICE,fallbackFactory = AuthWebServiceFallbackFactory.class)
